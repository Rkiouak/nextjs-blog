...
export async function getStaticPaths() {
  ...
  return {
    paths: paths,
    // fallback: 'blocking' means server-render pages not generated at build time on first request, then cache.
    // Use `true` if you want to show a loading fallback UI immediately.
    // Use `false` if you know ALL possible paths at build time and others should 404.
    fallback: false,
  };
}
